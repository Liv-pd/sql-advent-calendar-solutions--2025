...
SELECT l.break_id, t.cocoa_name, lo.location_name
FROM cocoa_logs as l
LEFT JOIN
    cocoa_types as t ON l.cocoa_id = t.cocoa_id
INNER JOIN
    break_schedule as s ON s.break_id = l.break_id
INNER JOIN
    locations as lo on s.location_id = lo.location_id
